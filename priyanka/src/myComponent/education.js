...
function getStepContent(step) {
  switch (step) {
    case 0:
      return `Pursuing Bachelor of Engineering in Computer Science from Presidency University, Bangalore`;
    case 1:
      return "Completed Higher Secondary with 69.83% from SEA College, Bangalore ";
    case 2:
      return `Completed High School with 85.12%  from SEA School, Bangalore`;
    default:
      return "Unknown step";
  }
}
...
class VerticalLinearStepper extends Component {
  state = {
    activeStep: 0,
    year: ["2017 - 2021", "2015 - 2017", "2014 - 2015"]
  };
  handleNext = () => {
    this.setState(state => ({
